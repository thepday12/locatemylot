...
public class CLPath {
    ...
    public static List<Vertex> getAllEntriesByCarparkId(int carparkId, String floor) {
        return getAllVertexByCarparkId(carparkId, floor);
    }
    ...
    public static List<Vertex> getAllVertexByCarparkId(int carparkId, String floor) {
        ...
        final String whereClause = "CARPARK_ID=? AND FLOOR=?";
        final String[] whereArgs = {
                String.valueOf(carparkId),
                floor
        };
