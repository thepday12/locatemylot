...
public class HelpFragment extends Fragment {
    ...
    private RelativeLayout rlHelpMenu;
    private RelativeLayout llEntryTime, llTotalDuration, llParkingRates;
    ...
    private void showLayout() {
        switch (position) {
            ...
            case 4: {
                ...
                if (isCheck)
                    func_way.setImageResource(R.drawable.bg_blue_c);
            ...
            case 5:
            {
                ...
                if (isCheck)
                    func_check_in.setImageResource(R.drawable.bg_blue_c);
                ivHelpWay.setImageResource(R.drawable.check_in_out_help);
                RelativeLayout.LayoutParams layoutParams = (RelativeLayout.LayoutParams) ivHelpWay.getLayoutParams();
                layoutParams.leftMargin = screenWidth / 10*2;
                ivHelpWay.setLayoutParams(layoutParams);
                showHelp(rlFuncCheck);
                showHelp(ivHelpWay);
            }

                break;
            case 6:{
                ivHelpWay.setImageResource(R.drawable.camera_help);
                RelativeLayout.LayoutParams layoutParams = (RelativeLayout.LayoutParams) ivHelpWay.getLayoutParams();
            ...
            case 7:
            {
                ...
                RelativeLayout.LayoutParams layoutParams = (RelativeLayout.LayoutParams) ivHelpWay.getLayoutParams();
                layoutParams.rightMargin = (int) (screenWidth / 10*2f);
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        llEntryTime = (RelativeLayout) rootView.findViewById(R.id.llEntryTime);
        llTotalDuration = (RelativeLayout) rootView.findViewById(R.id.llTotalDuration);
        llParkingRates = (RelativeLayout) rootView.findViewById(R.id.llParkingRates);
